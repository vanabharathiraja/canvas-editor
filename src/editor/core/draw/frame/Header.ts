...
export class Header {
  ...
  // Check if header uses full-width background
  public isFullWidth(): boolean {
    return this.options.header.fullWidth
  }

  // Get content width based on options
  private _getContentWidth(): number {
    const { fullWidth, contentFullWidth } = this.options.header
  ...
  public getBackground(): IHeaderBackground {
    return this.options.header.background
  }

  public setBackground(background: IHeaderBackground) {
    Object.assign(this.options.header.background, background)
  }
  ...
  private _renderBackgroundImage(
    ...
    const background = this.options.header.background
